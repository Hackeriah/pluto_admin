...
export default function LandmarkEditModal({ isOpen, closeModal,initialData }) {
 ...
 const dropdowns= [
    ...
    { label: "Area", options: status, buttonLabel: "Select state fr....",},
    { label: "Zone", options: status, buttonLabel: "Select state fr....",},
]
  const inputs = [
    { id: "landmarkName", label: "Landmark Name", placeholder: "Enter area name here",value: areaName, onChange: handleAreaNameChange },
    { id: "areaCode", label: "Landmark Code", placeholder: "Enter Unique code or Auto generated", value: areaCode, onChange: handleAreaCodeChange},
    { id: "areaName", label: "Creation Cost", placeholder: "Enter area name here",value: areaName, onChange: handleAreaNameChange },
];
  ...
  return (
    <ModalWrapper title="NEW LANDMARK" closeModal={closeModal} buttons={buttons}>
      ...
      <ModalSection title="">
        <div className="flex flex-wrap justify-between">
          ...
          {inputs.map((input, idx) => (
            <InputBtn key={idx} {...input} className="w-[49%] mb-4" />
          ))}
      </div>
      </ModalSection>
    </ModalWrapper>
